...
import 'package:remittance/app/utils/enums.dart' show PageTransitionType;
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    /// PageTransitionType.rotate which is the rotate functionality for transition you can also use alignment for this transition
      ...
      case PageTransitionType.rotate:
        assert(alignment != null, """When using type "RotationTransition" you need argument: 'alignment'""");
